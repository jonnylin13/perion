...
describe('titan.Packet.Parser', function() {
  it('should read a byte, ubyte', function() {
    const packet = new Packet.Parser(Buffer.from([0x2, 0x2]));
  ...
  it('should read a few bytes and collect', function() {
    const packet = new Packet.Parser(Buffer.from([0x1, 0x2, 0x3]));
...
describe('titan.Packet.Writer', function() {
  it('should write a byte, ubyte', function() {
    const packet = new Packet.Writer(2);
  ...
  it('should write a short, ushort', function() {
    const packet = new Packet.Writer(4);
  ...
  it('should write an int, uint', function() {
    const packet = new Packet.Writer(8);
  ...
  it('should write a long, ulong', function() {
    const packet = new Packet.Writer(16);
